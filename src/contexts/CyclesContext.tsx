...
import { ActionTypes, addNewCycleAction, interrupedCurrentCycleAction, markCurrentCycleAsFinishedAction } from "../reducers/cycles/actions";
...
export function CyclesContextProvider({children}: CyclesContextProviderProps) {
    ...
    //irá salvar as informações no local storage do navegar
    useEffect(() => {
